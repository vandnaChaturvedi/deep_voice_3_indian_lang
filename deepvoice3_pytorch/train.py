...
def eval_model(global_step, writer, device, model, checkpoint_dir, ismultispeaker):
    ...
    texts = [
        ...
        u"इस दिशा में कोई प्रगति नहीं कर पा रहा था",
        u"यह उससे भी बढ़कर है",
        u"अवधेश या भौतिक समतुल्य में रूपांतरण हो",
        u"उसने कल्पना में डॉक्टर को साफ देखा",
        u"और बता तू भी करेंगे",
        ...
        u"आंखों को स्वस्थ करने के विचार से भर गया",
        u"हिंदी ऑडियो बुक डॉट कॉम",
        u"या आप कभी भी सिर्फ पर नहीं पहुंचेंगे",
        u"विश्व के सभी हिस्सों में",
        u"क्या वह नंबर एक ही तलाश कर रहे हैं",
        u"आपके अवचेतन मन की शक्ति",
...
Please set a larger value for ``max_position`` in hyper parameters.""".format(
            ...
            if global_step == 0 or global_step % hparams.eval_interval == 0:
